...
<body>
	...
	<nav
		...
		<div class="container">
			<a class="navbar-brand d-flex align-items-center" href="index.jsp">
				<img src="assest/logo.png" alt="BizCard AI Logo" width="35"
		...
		<div class="container">
			...
			<div class="row g-4">
				<div class="col-12 col-sm-6 col-lg-3" data-aos="zoom-in"
					data-aos-delay="100">
					<img src="assest/card-1.png" class="img-fluid rounded shadow"
						alt="Card 1">
				</div>
				<div class="col-12 col-sm-6 col-lg-3" data-aos="zoom-in"
					data-aos-delay="200">
					<img src="assest/card-4.png" class="img-fluid rounded shadow"
						alt="Card 2">
				</div>
				<div class="col-12 col-sm-6 col-lg-3" data-aos="zoom-in"
					data-aos-delay="300">
					<img src="assest/card-3.png" class="img-fluid rounded shadow"
						alt="Card 3">
				</div>
				<div class="col-12 col-sm-6 col-lg-3" data-aos="zoom-in"
					data-aos-delay="400">
					<img src="assest/card-2.png" class="img-fluid rounded shadow"
						alt="Card 4">
				</div>
			</div>
		</div>
	...
	<section id="about" class="container">
		<div class="row align-items-center g-5">
			...
			<div class="col-lg-6" data-aos="fade-up">
				<img src="assest/about.png" class="img-fluid rounded shadow"
					alt="About Project">
			</div>
		</div>
	</section>
			...
			<div class="row text-center text-md-start gy-4">
				<div class="col-lg-4 col-md-12">
					<div
						...
						<img src="assest/logo.png" alt="BizCard AI Logo" width="45"
