...
//			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/bizcard_ai", "root", "root");
		  ...
		  try {
	            Class.forName("com.mysql.cj.jdbc.Driver");
	          Connection  con = DriverManager.getConnection("jdbc:mysql://bizcard-db-bizcard-project.f.aivencloud.com:14273/defaultdb?sslmode=REQUIRED", "avnadmin", "AVNS_YUkC8oAfQsPM2aJ_kKg");
